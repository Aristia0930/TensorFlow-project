...
public class IndexController {
    ...
    public String classifyImage(@RequestParam("file")MultipartFile file ,Model data) throws IOException {
        ...
        data.addAttribute("ans",(String)categories[predictedClassIndex]);
        return "mainPage";
